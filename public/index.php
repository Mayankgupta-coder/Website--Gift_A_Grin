...
<body id="page-top">
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      ...
      <li class="sidebar-nav-item">
        <a class="js-scroll-trigger" href="home.php">New Arrivals</a>
      </li>
      <li class="sidebar-nav-item">
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      ...
      <a class="btn btn-primary btn-lg js-scroll-trigger" href="home.php">Products</a>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
          ...
          <a href="categories.php?id=<?php echo $list['id']?>"><i class="fas fa-gift"></i></a>
          </span>
          <h4>
      ...
      <h3 class="mb-5">Contact Us</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mr-auto text-center mb-5 mb-lg-0">
                ...
                <div class="mb-2">amritasoni1996@gmail.com</div>

            </div>
            <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
              <i class="icon-social-instagram fa-3x text-muted rounded-circle"></i>
              <a class="d-block text-white" href="https://www.instagram.com/gift.a.grin/" target="_blank" class="mb-2">@gift.a.grin</a>
          </div>
        </div>
